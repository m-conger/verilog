...
HD_PWD='C:/conger/YONGA/verilog/vivado/testbench_ornegi/testbench_ornegi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arbiter_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arbiter_tb.tcl
